...
def layer_daily_transaction_get_list_query(user):
    ...
    if "Administrator" not in [role.role for role in user_role]:
        ...
        return "(`tabLayer Daily Transaction`.batch IN ({batch_names}))".format(
